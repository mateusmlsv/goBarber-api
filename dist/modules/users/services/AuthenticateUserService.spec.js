...
describe('AuthenticateUser', function () {
    it('should be able to authenticate', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeHashProvider, createUser, anthentitaceUser, user, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    anthentitaceUser = new AuthenticateUserService_1.default(fakeUsersRepository, fakeHashProvider);
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, anthentitaceUser.execute({
                            email: 'johndoe@hotmail.com',
                            password: '123456',
                        })];
                case 2:
    ...
    it('should not be able to authenticate with no existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeHashProvider, anthentitaceUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUsersRepository_1.default();
                    fakeHashProvider = new FakeHashProvider_1.default();
                    anthentitaceUser = new AuthenticateUserService_1.default(fakeUsersRepository, fakeHashProvider);
                    return [4 /*yield*/, expect(anthentitaceUser.execute({
                            email: 'johndoe@hotmail.com',
                            password: '123456',
    ...
    it('should not be able to authenticate with wrong password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeHashProvider, createUser, anthentitaceUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUsersRepository_1.default();
